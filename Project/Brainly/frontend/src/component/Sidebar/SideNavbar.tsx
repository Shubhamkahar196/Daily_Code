...
const SideNavbar = (props: SideNavbarProps)=>{
  ...
  return <>
    <div className="w-[20vw] h-screen border-r-2 inline-block">
        ...
        <div className="pt-7">
          <div onClick={al}><Navbar text={"All"} startIcon={<All />} /></div>
          <div onClick={yt}><Navbar text={"Youtube"} startIcon={<YoutubeIcon />} /></div>
          <div onClick={nt}><Navbar text={"Documents"} startIcon={<DocumentIcon />} /></div>
        </div>
    </div> 
  </>
}
